import Baduy from "../../assets/img/SukuBaduy/image.png";
import Dayak from "../../assets/img/SukuDayak/image.png";
import Kajang from "../../assets/img/SukuKajang/image.png";
import Toraja from "../../assets/img/SukuToraja/image.png";
import Bugis from "../../assets/img/SukuBugis/image.png";
import Jambi from "../../assets/img/SukuAnakDalam/image.png";
...
export const images2 = [Baduy, Dayak, Kajang, Toraja, Bugis, Jambi];
...
export const transformStyles = [
  ...
  "translateX(150px) scale(0.95) rotate(4deg)",
  "translateX(200px) scale(0.95) rotate(4deg)",
];
